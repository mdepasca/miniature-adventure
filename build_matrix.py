...
if __name__ == "__main__":
	...
	print 'mat01 ...'
	mat01 = np.loadtxt(args.path+fileName.format(timeStamps[1]))

	print 'mat02 ...'
	mat02 = np.loadtxt(args.path+fileName.format(timeStamps[2]))

	print 'mat03 ...'
	mat03 = np.loadtxt(args.path+fileName.format(timeStamps[3]))
	...
	print 'mat11 ...'
	mat11 = np.loadtxt(args.path+fileName.format(timeStamps[4]))

	print 'mat12 ...'
	mat12 = np.loadtxt(args.path+fileName.format(timeStamps[5]))

	print 'mat13 ...'
	mat13 = np.loadtxt(args.path+fileName.format(timeStamps[6]))
	...
	print 'mat22 ...'
	mat22 = np.loadtxt(args.path+fileName.format(timeStamps[7]))

	print 'mat23 ...'
	mat23 = np.loadtxt(args.path+fileName.format(timeStamps[8]))
	...
	print 'mat33 ...'
	mat33 = np.loadtxt(args.path+fileName.format(timeStamps[9]))
